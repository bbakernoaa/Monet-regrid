                ...
                if not potential_lat_coords and not potential_lon_coords:
                    for coord_name in ds.coords:
                        ...
                        if coord_var.ndim == 2:
                            ...
                            if "degree" in units and (
                                "north" in units or "lat" in str(coord_name).lower()
                            ):
                                potential_lat_coords.append(coord_name)
                            elif "degree" in units and (
                                "east" in units or "lon" in str(coord_name).lower()
                            ):
                                potential_lon_coords.append(coord_name)
                        ...
                        if coord_var.ndim == 1:
                            if (
                                ...
                                lat_1d_names = [
                                    ...
                                    if ds[name].ndim == 1
                                    and (
                                        "lat" in str(name).lower()
                                        or "y" in str(name).lower()
                                    )
                                ]
                                lon_1d_names = [
                                    name
                                    ...
                                    if ds[name].ndim == 1
                                    and (
                                        "lon" in str(name).lower()
                                        or "x" in str(name).lower()
                                    )
                                ]
...
def validate_grid_compatibility(
    source_ds: xr.Dataset, target_ds: xr.Dataset
